...
prop = " prop=efg"
volume = " volume"
solvent = " SCRF=(Solvent=tetrahydrofuran,SMD)"
tddft = " td=(50-50,nstates=12)"
method = {
"opt": "# B3LYP/6-311++G(d,p) symmetry=loose  empiricaldispersion=GD3BJ int=(grid=ultrafine)",
"sp1":  "# M062X/6-311++G(d,p) int=(grid=ultrafine)" + solvent + nbo + polar + prop + volume,
"sp2":  "# M062X/6-311++G(d,p) int=(grid=ultrafine)" + solvent + nmr,
...
keywords = {
0:" opt=(calcfc,tight) freq=noraman",
